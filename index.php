        ...
        <div class="produce__list">
          ...
          <div class="produce__item produce__item--third">
            <div class="produce__about-block">
              ...
              <a class="produce__link link-hy link-arrow-hy" href="#">Подробнее</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="sector__content">
        <div class="sector__left">
          ...
          <div class="sector__image-block">
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector1.jpg" alt="" data-visible="visible" data-num="1" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector2.jpg" alt="" data-visible="" data-num="2" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector3.jpg" alt="" data-visible="" data-num="3" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector4.jpg" alt="" data-visible="" data-num="4" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector5.jpg" alt="" data-visible="" data-num="5" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector6.jpg" alt="" data-visible="" data-num="6" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector7.jpg" alt="" data-visible="" data-num="7" />
            <img class="sector__image" src="<?= get_template_directory_uri()?>/assets/images/sector8.jpg" alt="" data-visible="" data-num="8" />
          </div>
        </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector1.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector2.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector3.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector4.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector5.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector6.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector7.jpg" alt="" />
            </div>
          ...
          <div class="swiper-slide">
            <div class="sector-mobile__image-block">
              <img class="sector-mobile__image" src="<?= get_template_directory_uri()?>/assets/images/sector8.jpg" alt="" />
            </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="swiper__image-block">
                <img class="slider-img" src="<?php echo get_bloginfo('template_url')?>/assets/images/project1.png" alt=""/>
              </div>
      ...
      <div class="about__content">
        ...
        <div class="about__right">
          <div class="about__image-block">
            <img class="about__image about__image--large" src="<?= get_template_directory_uri()?>/assets/images/about.jpg" alt="" />
            <img class="about__image about__image--big" src="<?= get_template_directory_uri()?>/assets/images/about-big.jpg" alt="" />
            <img class="about__image about__image--small" src="<?= get_template_directory_uri()?>/assets/images/about-small.jpg" alt="" />
          </div>
        </div>
      </div>
