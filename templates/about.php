      ...
      <div class="benefits__list">
        ...
        <div class="benefits__item">
          ...
          <p class="benefits__descr">
            ...
            предоставляют услуги по генеральному проектированию, строительно-монтажным работам, поставляют сопутствующие
            материалы.
          </p>
        </div>
        ...
        <div class="benefits__item">
          ...
          <p class="benefits__descr">
            Понимаем важность индивидуального подхода к каждому клиенту и готовы на реализацию проектов любой сложности
            в зависимости от задач. Знаем, как делать и небольшие стандартные здания, и масштабные строительные проекты.
          </p>
        </div>
