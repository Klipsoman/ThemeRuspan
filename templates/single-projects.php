          ...
          <div class="about-project__result">
            ...
            <div class="about-project__right">
              <div class="about-project__video-box">
                <iframe width="100%" height="100%" src="<?= CFS()->get('project_youtube');?>"
          ...
          <div class="delivered-products__item delivered-card">
            ...
            <div class="delivered-card__bottom">
              <div class="delivered-card__left">
                <a class="delivered-card__btn btn-gold btn"
                  href="<?= $product['project_products_link']; ?>">Подробнее</a>
              </div>
              <div class="delivered-card__right">
                ...
                if ($tag_color_gold) {
                 ...
                 ?>"><?php
                 if ($tag['project_products_tags_name']) {
                  echo $tag['project_products_tags_name'];
                 } else {
                  echo '';
                 };?></div>
                  <?php } } ?>
