    ...
    <div class="page-photo-description__content">
      <div class="page-photo-description__left">
        <div class="page-photo-description__photo-box">
          <img class="page-photo-description__photo" src="<?= get_template_directory_uri()?>/assets/images/progonnye-sistemy1.jpg" alt="" />
        </div>
      </div>
      ...
      <div class="area">
        <div class="area__left">
          ...
          <div class="area__image-box">
            <img src="<?= get_template_directory_uri()?>/assets/images/run-sistem-area.jpg" alt="area" class="area__image" />
          </div>
      ...
      <div class="fireresist">
        <div class="fireresist__left">
          ...
          <div class="fireresist__image-box">
            <img src="<?= get_template_directory_uri()?>/assets/images/run-sistem-fireresist.svg" alt="" class="fireresist__image" />
          </div>
      ...
      <div class="individual">
        <div class="individual__left">
          <div class="individual__image-box">
            <img src="<?= get_template_directory_uri()?>/assets/images/run-sistem-individual.jpg" alt="" class="individual__image" />
          </div>
        </div>
      ...
      <div class="roofs">
        <div class="roofs__left">
          <div class="roofs__image-box">
            <img src="<?= get_template_directory_uri()?>/./assets/images/run-sistem-roof1.jpg" alt="" class="roofs__image" />
          </div>
        ...
        <div class="roofs__right">
          <div class="roofs__image-box">
            <img src="<?= get_template_directory_uri()?>/./assets/images/run-sistem-roof2.jpg" alt="" class="roofs__image" />
          </div>
