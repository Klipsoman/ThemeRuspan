  ...
  <div class="privacy">
    <div class="container">
      <div class="privacy__block">
        <div class="privacy__title description">1. Общие положения</div>
        <p class="privacy__descr description-secondary description-secondary--black">
        ...
        <p class="privacy__descr description-secondary description-secondary--black">
          ...
          веб-сайта https://ruspan.su.
        </p>
        <div class="privacy__title description">
        ...
        <p class="privacy__descr description-secondary description-secondary--black">
          2.10. Пользователь – любой посетитель веб-сайта https://ruspan.su.
        </p>
